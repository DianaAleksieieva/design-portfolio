    ...
    <section className="Twizzlers">
      <div className="Container">
        ...
        <p className="Project-description">
          The main idea of this work is to redesign the package for well-known
          candies "Twizzlers". The old package becomes old-fashioned with a lot
          of different fonts and effects on the. The main advantages of the new
          pack are the harmony between elements, new graphics design, and modern
          fonts (primary and secondary). The juicy cherries were added to relate
          sweets to their flavor. In addition, the advertisement poster was
          created.
        </p>
        <img
